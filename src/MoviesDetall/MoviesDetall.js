...
import { setMovieDetall } from '../components/Store/actions';
...
const MoviesDetall = (props) => {

    const {movie, showModal} = props;
    const dispatch = useDispatch();

    const handleCloseModal = () => {
        dispatch(setMovieDetall(null));
    }
...
const MoviesDetallModal = styled.div `
.backdrop {
    position: fixed;
    top: 0;
    left: 0;
